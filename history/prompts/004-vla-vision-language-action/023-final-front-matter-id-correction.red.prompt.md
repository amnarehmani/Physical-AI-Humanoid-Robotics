---
id: 023
title: Final Front Matter ID Correction
stage: red
date: 2025-12-08
surface: agent
model: gemini
...
labels: ["fix", "front-matter", "docusaurus", "id"]
links:
...
- 📁 Files: 22 Markdown files updated.
- 🔁 Next prompts: None.
- 🧠 Reflection: Learned and applied Docusaurus-specific `id` field requirements for files within subfolders.
